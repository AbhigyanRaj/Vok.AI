...
const LANGUAGES = [
  ...
  { id: 'hindi', name: 'हिंदी (Hindi)', available: true },
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:gap-5 w-full max-w-md mx-auto p-2 sm:p-0">
      ...
      {selectedLanguage === 'hindi' && (
        <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3 text-xs text-blue-300 flex items-start gap-2">
          ...
          <div>
            <div className="font-semibold mb-1">हिंदी भाषा चयनित (Hindi Language Selected)</div>
            <div>Vok.AI will speak in Hindi for greetings, confirmations, and outros. <strong>Please ensure your voice module questions are also in Hindi</strong> for a consistent experience.</div>
          </div>
        </div>
      )}
